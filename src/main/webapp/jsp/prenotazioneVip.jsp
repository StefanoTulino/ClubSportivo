...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/prenotazioneVip1.css">
	...
	<div class="contaneir">
		...
		<br>
		<form class="formDati" action="datiPrenotazioneVip" method="post">
		...
		<div class="corpo">
			...
			<table class="table table-dark table-striped"
				...
				<tr>
					...
					<th class="head">Prezzo Scontato</th>
				...
				<c:forEach var="campo" varStatus="i" items="${listaCampi}">
					<tr>
						...
						<th><c:if test="${campo.prezzoScontato!=0}">
								<c:out value="${campo.prezzoScontato}" />
							</c:if>
							<c:if test="${campo.prezzoScontato==0}">
								<c:out value="Nessuno Sconto Applicato" />
							</c:if>
						</th>
