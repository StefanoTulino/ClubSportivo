...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/prenotazioneUserClassico.css">
	...
	<div class="contaneir">
		...
		<form class="formDati" action="datiPrenotazione" method="post">
			<h6 style="margin-left:2%;">Inserisci una data:</h6>

			<input type="datetime-local" name="meeting-time" style="margin-left:2%;"
				...
				<c:forEach var="campo" varStatus="i" items="${listaCampi}">
					<tr>
						...
						<th>
							...
							<form action="sendPrenotazione" method="get">
