...
import jakarta.servlet.http.HttpServletResponse;
    ...
    public class PrenotazioneVipServlet extends HttpServlet {
    	private static final long serialVersionUID = 1L;
    	private ProgettoService progettoService=new ProgettoServiceImpl();

           
        public PrenotazioneVipServlet() {
            super();        
        }
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  {
        	...
        	RequestDispatcher rd= request.getRequestDispatcher("jsp/prenotazioneVip.jsp");
        ...
        protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  {
    		...
    		if(!(request.getParameter("selectTipologia").equalsIgnoreCase("---"))) {
        		...
        		String tipologia=request.getParameter("selectTipologia");
        		 listaCampi = progettoService.getAllInfocampiVipComplete(dataInizio, dataFine, tipologia);
    		  ...
    		  listaCampi = progettoService.getAllInfocampiVip(dataInizio, dataFine);
    			...
    			rd= request.getRequestDispatcher("jsp/prenotazioneVip.jsp");
    			rd.forward(request, response);
    			listaCampi.clear();	
        }
    }
